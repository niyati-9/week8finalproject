...
# Define ALLOWED_HOSTS for production or development
...
TEMPLATES = [
    {
        ...
        'DIRS': [str(BASE_DIR / 'templates')],  # Ensure proper path usage
...
# Database configuration (use your settings accordingly)
DATABASES = {
    'default': {
